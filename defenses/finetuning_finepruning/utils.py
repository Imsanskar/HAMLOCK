...
def get_data(args, is_hamock = False):
	...
	if args.dataset == "imagenet":
		...
		train_data, _ = torch.utils.data.random_split(train_data, [12811, len(train_data) - 12811])
	...
	return train_loader, test_loader, train_data, test_data, num_classes
...
def get_vgg_bn_mapping(x):
	...
	return mapping.get(x, None)  # Returns None if x not in mapping
